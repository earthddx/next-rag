...
export default () => {
    ...
    //FIXME: have to use useChat() hook to replace messages, status, and sendMessage
    ...
    //                     switch (part.type) {
    //                         case "text": 
    //                         return <p key={`${message.id}-${index}`}>
    //                             <Message from={message.role}><Response>
    //                                 {part.text}</Response></Message>
    //                         </p>;
    //                         default: return null;
    //                     }
    //                 })}
