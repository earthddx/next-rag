...
export default ({ containerRef, threshold = 100 }: ScrollToBottomProps) => {
    ...
    return (
        ...
        >
            ...
            <div aria-hidden="true">
                <div
                    className={`absolute blur-md transition duration-300 pointer-events-none w-8 text-amber-500 inline-block select-none ${isHovered ? 'opacity-100' : 'opacity-0'
                        }`}
                >
                    <svg
